...
def dqn_train(iterations = 300):
    ...
    for itr in range(iterations):
        ...
        for k in range(batch_size):
            ...
            loss_per_batch += agent.optimise_model(batch_sample[k])
            gradient_steps += 1
...
if __name__ == '__main__':
    ...
    agent = DQN_agent(state_size,action_size,batch_size,seed)
    ...
    with open(f'Data/DQN_{args.expname}.csv', "a", newline='') as f:
        writer = csv.writer(f)
