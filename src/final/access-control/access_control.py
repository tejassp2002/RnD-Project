...
class AccessControl(BaseEnvironment):
    ...
    def env_step(self, action):
        ...
        self.reward_obs_term = [reward/(2**(self.num_priorities-1)), observation, False]
...
def main():
    ...
    obs = env.env_start()
    print(torch.tensor(np.array([env.env_start()]),dtype=torch.float32).shape)
