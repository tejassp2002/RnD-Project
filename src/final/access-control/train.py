...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="Access_Control",help="the environment id")
...
if __name__ == "__main__":
    ...
    # env setup
    env = AccessControl()
    env.env_init({'random_seed': args.seed})
    ...
    eval_env = AccessControl()
    eval_env.env_init({'random_seed': args.seed*2+8})
