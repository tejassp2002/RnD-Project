...
class DQN(object):
    def __init__(self,env,actions,device,args) -> None:
        ...
        self.target_net = QNetwork(env.env_start().shape,3).to(device)
    ...
    def learn(self,
        ...
        for global_step in range(total_timesteps):
            ...
            if global_step > args.learning_starts:
                ...
                if self.gradient_steps % args.target_network_frequency == 0:
                    self.target_net.load_state_dict(self.q_net.state_dict())
                ...
                if self.gradient_steps % args.eval_frequency == 0:
                    ...
                    # video.release()
                    if args.track:
                        # if args.capture_video and (global_step % (total_timesteps//20) == 0): 
